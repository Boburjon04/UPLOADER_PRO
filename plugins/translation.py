...
"""
    ABOUT_TEXT = """
**📛 My Name** : [Uploader PRO Bot 🚀](http://t.me/about_bots04)

**❤️ Version** : [2.3 🔥](http://t.me/about_bots04)

**🤖 Source** : [Click](https://github.com/Boburjon04)

**🧿 Language** : [Python 3.10.9](https://www.python.org/)

**📢 Framework** : [Pyrogram 1.4.16](https://docs.pyrogram.org/)

**👨‍💻 Developer** : [Bobur](https://t.me/Bobur_Ravzatov)
